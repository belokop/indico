...
class Config:
    ...
    __styles = {
        ...
        "albanova_lecture": ("AlbaNova lecture",
                             os.path.join("lectures", "IndicoLecture.tpl"),
                             os.path.join("lectures", "AlbaNovaLecture.css")),
        "nordita_lecture":  ("Nordita lecture",
                             os.path.join("lectures", "IndicoLecture.tpl"),
                             os.path.join("lectures", "NorditaLecture.css")),
        "event":            ("Event",
                             os.path.join("lectures", "IndicoLecture.tpl"),
                             os.path.join("lectures", "IndicoLecture.css")),
